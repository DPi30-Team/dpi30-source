...
.EXAMPLE
Set-SqlLoginPassword -SQLServerFqdn adap-foo-bar-sql.database.windows.net -SQLDatabase adap-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 SQLScript C:\Path\To\Script.sql
