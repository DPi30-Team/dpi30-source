...
.EXAMPLE
New-DatabaseFromBlobFile -SQLServerName adap-foo-bar-sql -SQLDatabase adap-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 -StorageUrl https://dfcfoobarstr.blob.core.windows.net/backup/db.bacpac -StorageAccountKey letmein==
