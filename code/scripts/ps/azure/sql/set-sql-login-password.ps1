...
.EXAMPLE
Set-SqlLoginPassword -SQLServerName adap-foo-bar-sql -SQLDatabase adap-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 -SQLLogin connection_user -SQLLoginPassword abc123
